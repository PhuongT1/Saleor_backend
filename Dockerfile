...
ENV RSA_PRIVATE_KEY ${RSA_PRIVATE_KEY:-dummy}

RUN SECRET_KEY=${SECRET_KEY} RSA_PRIVATE_KEY=${RSA_PRIVATE_KEY} STATIC_URL=${STATIC_URL} python3 manage.py collectstatic --no-input
